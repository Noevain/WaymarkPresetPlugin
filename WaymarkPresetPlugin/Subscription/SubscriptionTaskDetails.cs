...
{
	//from https://github.com/grittyfrog/MacroMate/blob/master/MacroMate/Subscription/SubscriptionTaskDetails.cs
	///<summary>
	///Helper class to display information about a subscription task to user
	///</summary>
